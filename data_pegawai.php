...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="x_panel">
      <div class="x_title">
        <h2>Data Pegawai <small>Daftar Pegawai Kantor Kementerian Agama Kota Sungai Penuh</small></h2>
        ...
        <table id="datatable" class="table table-striped table-bordered">
          ...
          <tbody>
            <?php
              ...
              $query = mysqli_query($koneksi,"SELECT * FROM pegawai pg, jabatan jb, golongan gl WHERE pg.id_jab=jb.id_jab and pg.id_gol=gl.id_gol order by pg.id_jab");
              $i = 1;
             ...
             <tr>
               ...
               <td><?php echo $row['nama_jab'] ?></td>
               <td><?php echo $row['nama_gol'] ?></td>
               <td><?php echo $row['unit_kerja']; ?></td>
               <td><?php echo $row['sisa_cuti']; ?></td>
               <td><?php echo $row['atasan']; ?></td>
               <td class="text-center">
                 <a href="#" class="btn btn-info" data-toggle="modal" data-target="#modalviewpegawai<?php echo $row['nip'] ?>"><i class="fa fa-eye"></i> Lihat</a>
                 <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#modaleditpegawai<?php echo $row['nip'] ?>"><i class="fa fa-edit"></i> Ubah</a>
                 <a href="#" class="btn btn-danger" data-toggle="modal" data-target="#modaldeletepegawai<?php echo $row['nip'] ?>"><i class="fa fa-trash"></i> Hapus</a>
               </td>
             </tr>
             ...
             <div class="modal fade" id="modaldeletepegawai<?php echo $row['nip']; ?>">
                   ...
                   <div class="modal-body">
                     <form class="" action="delete_pegawai.php" method="get">
                       <div class="form-group">
                         ...
                         <label>Semua data user, pegawai, dan cuti akan hilang</label>
              ...
              <!-- errornya mulai dr sini untuk modaledit nya bang-->
                     ...
                     <form class="" action="edit_pegawai.php" method="get">
                       ...
                       <div class="form-group">
                         ...
                         <select class="form-control" name="jabatan">
                           <option selected disabled><?php echo $row['nama_jab'] ?></option>
                           <?php
                           $jabatan = mysqli_query($koneksi, "SELECT * FROM jabatan");
                           while ($rowjab = mysqli_fetch_array($jabatan)) {
                             ?>
                             <option value="<?php echo $rowjab['id_jab']; ?>"><?php echo $rowjab['nama_jab']; ?></option>
                             <?php
                           }
                            ?>
                         </select>
                       ...
                       <div class="form-group">
                         ...
                         <select class="form-control" name="golongan">
                           <option selected disabled><?php echo $row['nama_gol'] ?></option>
                           <?php
                           $jabatan = mysqli_query($koneksi, "SELECT * FROM golongan");

                           while ($rowjab = mysqli_fetch_array($jabatan)) {
                             ?>
                             <option value="<?php echo $rowjab['id_gol']; ?>"><?php echo $rowjab['nama_gol']; ?></option>
                             <?php
                           }
                            ?>                               
                         </select>
                       ...
                       <div class="form-group">
                         ...
                         <input type="hidden" name="nip" value="<?php echo $row['nip']; ?>">
                         <input type="text" class="form-control" name="unit" value="<?php echo $row['unit_kerja']; ?>">
                       </div>  
                       <div class="form-group">
                         <label>Sisa Cuti</label>
                         <input type="hidden" name="nip" value="<?php echo $row['nip']; ?>">
                         <input type="text" class="form-control" name="sisa" value="<?php echo $row['sisa_cuti']; ?>">
                       </div> 
                       <div class="form-group">
                          <label>Atasan</label>
                          <select class="form-control" name="atasan">
                            <option selected disabled><?php echo $row['atasan'] ?></option>
                            <option>KEPALA KANTOR</option>
                            <option>KEPALA SUB BAGIAN TATA USAHA</option>
                            <option>KEPALA SEKSI PENDIS</option>
                            <option>KEPALA SEKSI BIMAS</option>
                            <option>KEPALA SEKSI PHU</option>
                          </select>                            
                       </div>                                                                   
                       <div class="form-group">
               ...
               <div class="modal-dialog">
                 <div class="modal-content">
                   ...
                   <div class="modal-body">
                     ...
                     <p class="text-muted"><?php echo $row['nama_jab']; ?></p>
                     <hr>
                     <strong>Golongan</strong>
                     <p class="text-muted"><?php echo $row['nama_gol']; ?></p>
                     <hr>
                     <strong>Unit Kerja</strong>
                     <p class="text-muted"><?php echo $row['unit_kerja']; ?></p>
                     <hr>
                     <strong>Sisa Cuti</strong>
                     <p class="text-muted"><?php echo $row['sisa_cuti']; ?></p>
                     <hr>
                     <strong>Atasan</strong>
                     <p class="text-muted"><?php echo $row['atasan']; ?></p>
                     <hr>                                          
                   </div>
                 </div>
               </div>
              ...
              <div class="modal-body">
                <form data-parsley-validate class="form-horizontal form-label-left" method="POST">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input class="form-control col-md-7 col-xs-12" type="text" name="unit" placeholder="Masukkan Unit Kerja">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input class="form-control col-md-7 col-xs-12" type="text" name="sisa" placeholder="Masukkan Sisa Cuti">
                    </div>
                  </div>

                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Atasan</label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <select class="form-control" name="pilihatasan">
...
if (isset($_POST['submit'])) {
    ...
    $unit = $_POST['unit'];
    $sisa = $_POST['sisa'];
    $atasan = $_POST['pilihatasan'];

    $insert = mysqli_query($koneksi, "INSERT INTO pegawai VALUES (null, '$namapegawai','$nippegawai', '$jabatanpegawai', '$golpegawai', '$unit', null, '$sisa', '$atasan')");   
